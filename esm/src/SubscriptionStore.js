...
import { DATA_CARD_ADD_ON_PRODUCT_NAME, MAIN_SIM_ADDRESS_IDENTIFIER, TWIN_CARD_ADD_ON_PRODUCT_NAME } from './consts.js';
    ...
    resolveProducts() {
        ...
        for (const childAddOnProduct of childrenAddOnProducts) {
            ...
            for (const parentAssignedProduct of parentAssignedProducts) {
                ...
                const identifier = resolveAssignedProductIdentifier(childAddOnProduct.identifier, undefined, parentAssignedProduct.inventoryId);
                const childProduct = {
                    identifier,
                    inventoryId: undefined,
