...
exports.toChangeSubscriptionPayload = void 0;
const SubscriptionStore_js_1 = require("./SubscriptionStore.js");
function toChangeSubscriptionPayload(msisdn, subscriptionStore, dataCardAddOnProductId, twinCardAddOnProductId) {
    ...
    const simCardProducts = productsToAdd
        .filter(p => (0, SubscriptionStore_js_1.isNewCard)(p?.card) && p.msisdn !== undefined && p.inventoryId === undefined)
        .map(p => ({
...
exports.toChangeSubscriptionPayload = toChangeSubscriptionPayload;
